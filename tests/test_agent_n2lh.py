...
class TestAgentN2LH:
    """ tests underlying agents beneath AgentN2LH """

    def test_n2lh_ble_commands(self):
        """ test won't auto-stop because BLE thread but, meh """
