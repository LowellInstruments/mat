...
# todo > -----------------------------------------------------
# todo > not properly done, should be a generic class
# todo > receiving a lc object of type cc26x2r or cc26x2r_sim
# todo > then 2 small classes, sending these lc objects
# todo > -----------------------------------------------------


class InterfaceTestBleCC26X2R(metaclass=abc.ABCMeta):
